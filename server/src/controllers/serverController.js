...
export const createData = (req, res) => {
  const {number, deliveryDate, cities, quantity, deliveryType, warehouse, status} = req.body;
  ...
  if (shipment) {
    const infoToAddShip = {
      ...
      cities: [
        ...
        { text: "Нижний Новгород", id: 5, selected: shipment.city === "Нижний Новгород" },
      ...
      deliveryType: [
        ...
        { text: "Монопаллета", id: 2, selected: shipment.deliveryType === "Монопаллета" }
      ],
      warehouse: [
        { text: "Склад", id: 1, selected: shipment.warehouse.name === "Склад" },
        { text: "СЦ Абакан", id: 2, selected: shipment.warehouse.name === "СЦ Абакан" },
        { text: "Черная Грязь", id: 3, selected: shipment.warehouse.name === "Черная Грязь" },
        { text: "Внуково", id: 4, selected: shipment.warehouse.name === "Внуково" },
        { text: "Белая дача", id: 5, selected: shipment.warehouse.name === "Белая дача" },
        { text: "Электросталь", id: 6, selected: shipment.warehouse.name === "Электросталь" },
        { text: "Вёшки", id: 7, selected: shipment.warehouse.name === "Вёшки" }
      ],
      status: [
        { text: "В пути", id: 1, selected: shipment.status === "В пути" },
        { text: "Задерживается", id: 2, selected: shipment.status === "Задерживается" }
      ]
    };
